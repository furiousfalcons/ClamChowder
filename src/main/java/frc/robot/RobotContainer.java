 ...
 */
public class RobotContainer<OutPut> {
  ...
  private final InTake inTake = new InTake(inTakeOutPut);
  ...
  static XboxController m_driverController2 = new XboxController(OIConstants.kDriverControllerPort1);
    ...
    private void configureButtonBindings() {
      ...
      JoystickButton outPutButton = new JoystickButton(m_driverController2, 6);
